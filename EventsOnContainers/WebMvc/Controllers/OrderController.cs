...
namespace WebMvc.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /*When the user clicks checkout in cart page, it goes to order page, it creates all 
         the cart items in the order page*/
        ...
        /*When the user clicks on place order in order page,that is when the below method
         gets called*/
        [HttpPost]
